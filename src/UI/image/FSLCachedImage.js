 ...
 * @date 2019/01/29
 * @class
 * @description 界面展示组件FSLCachedImage 支持缓存的Image控件
 * Support RN 0.52.0
 * 请使用FSLCachedImage组件替换旧的FSLCommonImage组件。1.3.6版本以后，FSLCommonImage不再维护
 *
...
export default class FSLCachedImage extends React.PureComponent {
    static propTypes = {
