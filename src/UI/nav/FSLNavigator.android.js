 ...
 * @date 2018/11/08
 * @class
 * @description 界面展示组件FSLNavigator 导航栏
 */
import React from 'react';
import PropTypes from 'prop-types';
import { StyleSheet, View, Text as NativeText, Dimensions } from 'react-native';
import { IconButton, TextButton, Title } from './FSLNavigationItems';

export default class FSLNavigator extends React.PureComponent {
    static propTypes = {
    ...
    render() {
        const { style, landscape, barTintColor, ...restProps } = this.props;
